...
function stoppedRuntimeBinding(
  ...
  const runtimePayload =
    runtime.runtimePayload && typeof runtime.runtimePayload === "object" && !Array.isArray(runtime.runtimePayload)
      ? {
      ...
      Effect.gen(function* () {
        ...
        for (const candidate of discoveredThreads) {
...

          {
            ...
            yield* providerService.stopSession({ threadId }).pipe(Effect.orElseSucceed(() => undefined));
